...
{
	const string DEF_MANAGER_PATH = "Assets/Easy Grip VR/Editor/DefinesManager.cs";
	const string SCRIPT_PATH = "Assets/Easy Grip VR/Scripts/SVControllerInput.cs";
	...
	[MenuItem("Window/Easy Grip VR SDK")]

	public static void OpenDefManager()
	{
		EditorWindow.GetWindow<DefineManager>(true, "Easy Grip VR SDK", true);
	}
	...
	void OnGUI() {
		...
		GUILayout.Label("Easy Grip VR SDK", EditorStyles.boldLabel);
